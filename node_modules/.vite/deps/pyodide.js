...
var L;
async function T() {
  if (!g || (z = (await import("./node_url-JAQFZPQ4.js")).default, H = await import("./node_fs-6FUIRYIC.js"), L = await import("./promises-BEBUHVUU.js"), V = (await import("./node_vm-ESTFYABK.js")).default, D = await import("./node_path-NMPDEQFX.js"), U = D.sep, typeof R < "u")) return;
  let e = H, t = await import("./node_crypto-J6WFDNPE.js"), o = await import("./ws-KJSI5IKA.js"), r = await import("./node_child_process-GBRVV4JM.js"), a = { fs: e, crypto: t, ws: o, child_process: r };
...
async function K() {
  ...
  if (g && !t.startsWith("file://") && (t = `file://${t}`), W) {
    let r = await import("./node_path-NMPDEQFX.js");
    return (await import("./node_url-JAQFZPQ4.js")).fileURLToPath(r.dirname(t));
  }
