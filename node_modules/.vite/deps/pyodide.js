...
for (b = 0; b < w.length; b++) p.prototype["get" + E(w[b])] = x(w[b]), p.prototype["set" + E(w[b])] = /* @__PURE__ */ function(e) {
  return function(t) {
    this[e] = !!t;
  };
}(w[b]);
var b;
for (v = 0; v < N.length; v++) p.prototype["get" + E(N[v])] = x(N[v]), p.prototype["set" + E(N[v])] = /* @__PURE__ */ function(e) {
  return function(t) {
...
var v;
for (h = 0; h < _.length; h++) p.prototype["get" + E(_[h])] = x(_[h]), p.prototype["set" + E(_[h])] = /* @__PURE__ */ function(e) {
  return function(t) {
    this[e] = String(t);
  };
}(_[h]);
...
var A = g && typeof module < "u" && typeof module.exports < "u" && typeof R < "u" && typeof __dirname < "u";
var W = g && !A;
...
var L;
async function T() {
  if (!g || (z = (await import("./node_url-VMBKG23O.js")).default, H = await import("./node_fs-23V4EMJG.js"), L = await import("./promises-K5HYVQP3.js"), V = (await import("./node_vm-JYILYGKA.js")).default, D = await import("./node_path-NZFCBJUN.js"), U = D.sep, typeof R < "u")) return;
  let e = H, t = await import("./node_crypto-2ATOA6Q4.js"), o = await import("./ws-7YXJRPZJ.js"), r = await import("./node_child_process-KDMSWPXV.js"), a = { fs: e, crypto: t, ws: o, child_process: r };
...
async function K() {
  ...
  if (g && !t.startsWith("file://") && (t = `file://${t}`), W) {
    let r = await import("./node_path-NZFCBJUN.js");
    return (await import("./node_url-VMBKG23O.js")).fileURLToPath(r.dirname(t));
  }
